...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		scoreText = new FlxText(10, 10, 0, "ROOK: 49324858", 36);
		...
		txtTracklist = new FlxText(FlxG.width * 0.05, yellowBG.x + yellowBG.height + 100, 0, "ROOK", 32);
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			{
				{
					video.playMP4(Paths.video('RookCutscene'));
