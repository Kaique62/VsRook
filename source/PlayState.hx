			...
			case 'entrance':
				{
						...
						ebg = new FlxSprite(-600, -200).loadGraphic(Paths.image('Rook/EntranceBg', 'shared'));
						ebg.antialiasing = true;
						ebg.scrollFactor.set(0.9, 0.9);
						ebg.active = false;
						add(ebg);

						peanut = new FlxSprite(370, -200).loadGraphic(Paths.image('Rook/Peanut', 'shared'));
						peanut.antialiasing = true;
						peanut.setGraphicSize(Std.int(peanut.width * 1.1));
						peanut.scrollFactor.set(0.9, 0.9);
						peanut.active = false;
		...
		if (SONG.song.toLowerCase() == 'rook')
			{
				...
				if (curStep == 315)
				{
					...
					ebg.visible = false; 
					FlxG.sound.play(Paths.sound('173move1'));
				}
				if (curStep == 320)
				{
					dad.visible = true;
					...
					ebg.visible = true;
					peanut.visible = true; 
					FlxG.sound.play(Paths.sound('173appear'));
				}
				if (curStep == 330)
				{
					dad.visible = false;
					...
					ebg.visible = false;
					peanut.visible = false; 
					FlxG.sound.play(Paths.sound('173move2'));
				}
				if (curStep == 335)
				{
					dad.visible = true;
